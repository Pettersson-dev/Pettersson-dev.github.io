...
header:
  overlay_color: "#000"
  overlay_filter: "0.3"
  overlay_image: /assets/images/adm-target-architecture.jpg
  caption: "Illustration: Custom adaptation of TOGAF ADM"
---
...
In this post, I’ll show a concrete version of how ADM can be applied in practice, tailored to a finance and transformation context.
...
![Target Architecture ADM](/assets/images/adm-target-architecture.jpg)
...
From capabilities, define digital building blocks. In my example, domains include customer interaction, transactions & payments, order & inventory, analytics & insights, and business administration. These are mapped to systems like CRM, ERP, Adyen, SAS, Tableau, and others.
