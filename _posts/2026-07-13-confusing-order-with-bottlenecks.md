...
The problem is rarely governance itself.

The problem is how decisions are made.

## Governance Should Create Flow

Good governance doesn't slow organizations down.

It enables predictable decision-making.
...
The faster decisions are made, the faster value is delivered.

## Removing Governance Creates Different Bottlenecks

Organizations sometimes celebrate removing architecture reviews.
...
Others should remain product decisions.

Others belong at the enterprise level.

The objective is not centralized control.

The objective is distributing decisions to the lowest responsible level.
...
When teams know the boundaries, they spend less time asking for permission.
