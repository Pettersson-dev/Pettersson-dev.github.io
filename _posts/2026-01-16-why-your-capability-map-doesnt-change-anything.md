...
1. Strategy is defined (often vaguely)  
2. A capability map is created or updated  
3. A target architecture / North Star is published  
4. Initiatives continue as planned  
...
1. **Capabilities become outcome-oriented**, not abstract  
2. **Initiatives must declare which capabilities they improve**  
3. **Portfolio discussions move from “what do we want to build?” to “what are we strengthening?”**  
